...
let DeviceController = class DeviceController {
    ...
    login(deviceLoginDto) {
        return this.deviceService.login(deviceLoginDto);
    }
    activate(deviceActivationDto) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [device_dto_1.DeviceLoginDto]),
    __metadata("design:returntype", void 0)
], DeviceController.prototype, "login", null);
__decorate([
    (0, common_1.Post)("activate"),
    (0, common_1.UsePipes)(new common_1.ValidationPipe({ transform: true })),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [device_dto_1.DeviceActivationDto]),
    __metadata("design:returntype", void 0)
], DeviceController.prototype, "activate", null);
__decorate([
    (0, common_1.Post)(),
